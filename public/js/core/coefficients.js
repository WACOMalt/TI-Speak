...
export const CHIRP_TABLE_SIGNED = CHIRP_TABLE.map(v => v > 127 ? v - 256 : v);

// Interpolation coefficients (shift values)
export const INTERP_COEFF = [0, 3, 3, 3, 2, 2, 1, 1];

// Sample rate (8 kHz)
export const SAMPLE_RATE = 8000;

// Samples per frame (200 samples = 25ms at 8kHz)
export const SAMPLES_PER_FRAME = 200;

// Interpolation periods per frame
export const INTERP_PERIODS = 8;

// Samples per interpolation period
export const SAMPLES_PER_INTERP = SAMPLES_PER_FRAME / INTERP_PERIODS; // 25
